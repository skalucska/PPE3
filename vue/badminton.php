...
<div>
    ...
    <h2>Vous vous interesez au Badmiton, alors nos articles sont fait pour vous.</h2> <!-- sql liste des categories -->

    <table>
      <caption>Tous les equipements de badminton, rien que pour vous </caption>
      <thead>
        <tr>
